...
class SaleCommissionLineMixin(models.AbstractModel):
    ...
    def _get_commission_amount(self, commission, subtotal, product, quantity):
        ...
        elif commission.commission_type == "section" and commission.section_type == "percentage":
            margin = max([0, subtotal - product.standard_price * quantity])
            return commission.calculate_section(subtotal, margin)
