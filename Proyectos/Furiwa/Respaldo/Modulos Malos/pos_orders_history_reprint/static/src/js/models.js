    ...
    models.PosModel = models.PosModel.extend({
        initialize: function () {
            ...
            this.ready.then(function () {
                self.bus.add_channel_callback("pos_orders_history_receipt", self.on_orders_history_receipt_updates, self);
            });
        ...
        on_orders_history_receipt_updates: function(message) {
            ...
            message.updated_receipts.forEach(function (id) {
                self.get_order_history_receipt(id).then(function(receipt) {
