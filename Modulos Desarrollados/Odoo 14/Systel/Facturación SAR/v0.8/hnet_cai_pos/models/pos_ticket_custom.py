...
class pos_order(models.Model):
    ...
    def _amount_line_tax_new(self, line, tax_name):
        """
        Obtener los impuestos y precios de la orden
        Retornar los valores de los impuestos sumarizados
        """
    ...
    def _amount_line_tax_new2(self, line, tax_name):
        """
        Obtener los impuestos y precios de la orden
        Retornar los valores de los impuestos
        """
        taxes_ids = line.product_id.taxes_id
    ...
    def _calculate_base(self, order):
        """
        Calculo de cada uno de los impuestos (15%, 18% y excento)
        """
        result = {}
    ...
    def create(self, values):
        ...
        Sobrescribir el método 'create' actualizando los impuestos y facturacion
        """
    ...
    def _order_fields(self, ui_order):
        ...
        res['tax_15'] = ui_order['tax_15']
        res['tax_18'] = ui_order['tax_18']
        res['tax_bf1'] = ui_order['tax_bf1']
        res['tax_bf2'] = ui_order['tax_bf2']
        res['tax_bf3'] = ui_order['tax_bf3']
        res['exento'] = ui_order['exento']

        return res
""" 
    # Necesario para la comunicación entre el backend y frontend (El método debe invocarse desde JS)
    @api.depends_context('_order_fields')
    ...
    def export_for_ui(self):
        return self.mapped(self._export_for_ui)
    ...
    def _order_fields(self, ui_order):
        ...
        res['note2'] = ui_order['note2']
        res['note3'] = ui_order['note3']
        res['facturacion'] = name
        res['exento'] = ui_order['exento']
        res['tax_15'] = tax_15
        res['tax_18'] = tax_18
        res['tax_bf1'] = base_exento
        res['tax_bf2'] = base_15
        result['tax_bf3'] = base_18
        return res
"""